...
//#endif
	...
	public:
		...
		const gElementProxy& gElementProxy::operator=(gVector::Scalar val) {
...
negat_exp_t<var_t<Scalar>> operator-(const gVector<Scalar>& gvec) {
	return negat_exp_t<var_t<Scalar>>(var_t<>(gvec));
}
...
********************************************************************************************/
template<typename Scalar>
minus_exp_t<var_t<Scalar>, var_t<Scalar>> operator-(
	const gVector<Scalar>& v1,
	const gVector<Scalar>& v2
	) {
	return minus_exp_t<var_t<Scalar>, var_t<Scalar>>(var_t<Scalar>(v1), var_t<Scalar>(v2));
}

template<typename Scalar>
minus_exp_t<scalar_t<>, var_t<Scalar>> operator-(
	Scalar s,
	const gVector<Scalar>& v2
	) {
	return minus_exp_t<scalar_t<>, var_t<>>(scalar_t<>(s), var_t<Scalar>(v2));
}

template<typename Scalar>
minus_exp_t<var_t<Scalar>, scalar_t<Scalar>> operator-(
	const gVector<Scalar>& v1,
	Scalar s
	) {
	return minus_exp_t<var_t<Scalar>, scalar_t<Scalar>>(var_t<Scalar>(v1), scalar_t<Scalar>(s));
}
...
template<typename Scalar, typename opExp2_t,  \
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >  \
	op##_exp_t<scalar_t<exp_scalar_t<opExp2_t>>, opExp2_t > operator##opsign##(  \
		Scalar s1,  \
		const opExp2_t& op2  \
		) { \
	static_assert(opExp2_t::is_exp, "Not a vector expression"); \
...
template<typename Scalar>
add_exp_t<var_t<Scalar>, var_t<Scalar>> operator+(
	const gVector<Scalar>& v1,
	const gVector<Scalar>& v2
	) {
	return add_exp_t<var_t<Scalar>, var_t<Scalar>>(var_t<Scalar>(v1), var_t<Scalar>(v2));
}

template<typename Scalar1, typename Scalar2>
add_exp_t<scalar_t<Scalar1>, var_t<Scalar2>> operator+(
	Scalar1 s,
	const gVector<Scalar2>& v2
	) {
	return add_exp_t<scalar_t<Scalar1>, var_t<Scalar2>>(scalar_t<Scalar1>(s), var_t<Scalar2>(v2));
}

template<typename Scalar1, typename Scalar2>
add_exp_t<var_t<Scalar1>, scalar_t<Scalar2>> operator+(
	const gVector<Scalar1>& v1,
	Scalar2 s
	) {
	return add_exp_t<var_t<Scalar1>, scalar_t<Scalar2>>(var_t<Scalar1>(v1), scalar_t<Scalar2>(s));
}
...
********************************************************************************************/
template<typename Scalar1, typename Scalar2>
multiply_exp_t<var_t<Scalar1>, var_t<Scalar2>> operator*(
	const gVector<Scalar1>& v1,
	const gVector<Scalar2>& v2
	) {
	return multiply_exp_t<var_t<Scalar1>, var_t<Scalar2>>(var_t<Scalar1>(v1), var_t<Scalar2>(v2));
}

template<typename Scalar1,typename Scalar2>
multiply_exp_t<scalar_t<Scalar1>, var_t<Scalar2>> operator*(
	Scalar1 s,
	const gVector<Scalar2>& v2
	) {
	return multiply_exp_t<scalar_t<Scalar1>, var_t<Scalar2>>(scalar_t<Scalar1>(s), var_t<Scalar2>(v2));
}

template<typename Scalar1, typename Scalar2>
multiply_exp_t<var_t<Scalar1>, scalar_t<Scalar2>> operator*(
	const gVector<Scalar1>& v1,
	Scalar2 s
	) {
	return multiply_exp_t<var_t<Scalar1>, scalar_t<Scalar2>>(var_t<Scalar1>(v1), scalar_t<Scalar2>(s));
}
...
********************************************************************************************/
template<typename Scalar1, typename Scalar2>
div_exp_t<var_t<Scalar1>, var_t<Scalar2>> operator/(
	const gVector<Scalar1>& v1,
	const gVector<Scalar2>& v2
	) {
	return div_exp_t<var_t<Scalar1>, var_t<Scalar2>>(var_t<Scalar1>(v1), var_t<Scalar2>(v2));
}

template<typename Scalar>
div_exp_t<scalar_t<Scalar>, var_t<Scalar>> operator/(
	Scalar s,
	const gVector<Scalar>& v2
	) {
	return div_exp_t<scalar_t<Scalar>, var_t<Scalar>>(scalar_t<Scalar>(s), var_t<Scalar>(v2));
}

template<typename Scalar>
div_exp_t<var_t<Scalar>, scalar_t<Scalar>> operator/(
	const gVector<Scalar>& v1,
	Scalar s
	) {
	return div_exp_t<var_t<Scalar>, scalar_t<Scalar>>(var_t<Scalar>(v1), scalar_t<Scalar>(s));
}
...
********************************************************************************************/
template<typename Scalar>
pow_exp_t<var_t<Scalar>, var_t<Scalar>> operator^(
	const gVector<Scalar>& v1,
	const gVector<Scalar>& v2
	) {
...
template<typename Scalar>
pow_exp_t<scalar_t<Scalar>, var_t<Scalar>> operator^(
	Scalar s,
	const gVector<Scalar>& v2
	) {
	return pow_exp_t<scalar_t<Scalar>, var_t<Scalar>>(scalar_t<Scalar>(s), var_t<Scalar>(v2));
}

template<typename Scalar>
pow_exp_t<var_t<Scalar>, scalar_t<Scalar>> operator^(
	const gVector<Scalar>& v1,
	Scalar s
	) {
	return pow_exp_t<var_t<Scalar>, scalar_t<Scalar>>(var_t<Scalar>(v1), scalar_t<Scalar>(s));
}
...
template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	minus_exp_t<opExp1_t, var_t<Scalar>> operator-(
		const opExp1_t& op1, const gVector<Scalar>& v2) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return minus_exp_t<opExp1_t, var_t<Scalar>>(op1, var_t<Scalar>(v2));
}

template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	minus_exp_t<opExp1_t, scalar_t<exp_scalar_t<opExp1_t>>> operator-(
	const opExp1_t& op1, 
		Scalar s2
	) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return minus_exp_t<opExp1_t, scalar_t<Scalar>>(op1, scalar_t<Scalar>(s2));
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	minus_exp_t<var_t<Scalar>, opExp2_t> operator-(
		const gVector<Scalar>& v1,
		const opExp2_t& op2
		) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return minus_exp_t<var_t<Scalar>, opExp2_t>(var_t<Scalar>(v1), op2);
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	minus_exp_t<scalar_t<exp_scalar_t<opExp2_t>>, opExp2_t > operator-(
		Scalar s1,
	const opExp2_t& op2
	) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return minus_exp_t<scalar_t<Scalar>, opExp2_t>(scalar_t<Scalar>(s1), op2);
}
...
template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0>
	add_exp_t<opExp1_t, var_t<Scalar>> operator+(
		const opExp1_t& op1, const gVector<Scalar>& v2) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return add_exp_t<opExp1_t, var_t<Scalar>>(op1, var_t<Scalar>(v2));
}

template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0>
	add_exp_t<opExp1_t, scalar_t<exp_scalar_t<opExp1_t>>> operator+(
	const opExp1_t& op1, 
		Scalar s2
	) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return add_exp_t<opExp1_t, scalar_t<Scalar>>(op1, scalar_t<Scalar>(s2));
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0>
add_exp_t<var_t<Scalar>, opExp2_t> operator+(
	const gVector<Scalar>& v1,
	const opExp2_t& op2) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return add_exp_t<var_t<Scalar>, opExp2_t>(var_t<Scalar>(v1), op2);
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	add_exp_t<scalar_t<Scalar>, opExp2_t > operator+(
	Scalar s1,
	const opExp2_t& op2
	) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return add_exp_t<scalar_t<Scalar>, opExp2_t>(scalar_t<Scalar>(s1), op2);
}
...
template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
multiply_exp_t<opExp1_t, var_t<Scalar>> operator*(
	const opExp1_t& op1, const gVector<Scalar>& v2) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return multiply_exp_t<opExp1_t, var_t<Scalar>>(op1, var_t<Scalar>(v2));
}

template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	multiply_exp_t<opExp1_t, scalar_t<Scalar>> operator*(
	const opExp1_t& op1, 
		exp_scalar_t<opExp1_t> s2
	) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return multiply_exp_t<opExp1_t, scalar_t<Scalar>>(op1, scalar_t<Scalar>(s2));
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	multiply_exp_t<var_t<Scalar>, opExp2_t> operator*(
		const gVector<Scalar>& v1,
		const opExp2_t& op2
		) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return multiply_exp_t<var_t<Scalar>, opExp2_t >(var_t<Scalar>(v1), op2);
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	multiply_exp_t<scalar_t<Scalar>, opExp2_t > operator*(
		scalar_t<Scalar>  s1,
	const opExp2_t& op2
	) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return multiply_exp_t<scalar_t<Scalar>, opExp2_t>(scalar_t<Scalar>(s1), op2);
}
...
template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
div_exp_t<opExp1_t, var_t<Scalar>> operator/(
	const opExp1_t& op1, const gVector<Scalar>& v2) {
	static_assert(opExp1_t::is_exp, "Not a vector expression !");
	return div_exp_t<opExp1_t, var_t<Scalar>>(op1, var_t<Scalar>(v2));
}

template<typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	div_exp_t<opExp1_t, scalar_t<exp_scalar_t<opExp1_t>>> operator/(
	const opExp1_t& op1,
		exp_scalar_t<opExp1_t> s2
	) {
	static_assert(opExp1_t::is_exp, "Not a vector expression !");
	return div_exp_t<opExp1_t, scalar_t<exp_scalar_t<opExp1_t>>>(op1, scalar_t<exp_scalar_t<opExp1_t>>(s2));
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
div_exp_t<var_t<Scalar>, opExp2_t> operator/(
	const gVector<Scalar>& v1,
	const opExp2_t& op2) {
	static_assert(opExp2_t::is_exp, "Not a vector expression !");
	return div_exp_t<var_t<Scalar>, opExp2_t>(var_t<Scalar>(v1), op2);
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	div_exp_t<scalar_t<Scalar>, opExp2_t > operator/(
	Scalar s1,
	const opExp2_t& op2
	) {
	static_assert(opExp2_t::is_exp, "Not a vector expression !");
	return div_exp_t<scalar_t<Scalar>, opExp2_t>(scalar_t<Scalar>(s1), op2);
}
...
template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	pow_exp_t<opExp1_t, var_t<Scalar>> operator^(
		const opExp1_t& op1, const gVector<Scalar>& v2) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return pow_exp_t<opExp1_t, var_t<Scalar>>(op1, var_t<Scalar>(v2));
}

template<typename Scalar, typename opExp1_t,
	typename std::enable_if<is_expression<opExp1_t>::value, int>::type = 0 >
	pow_exp_t<opExp1_t, scalar_t<Scalar>> operator^(
	const opExp1_t& op1, 
	Scalar s2
	) {
	static_assert(opExp1_t::is_exp, "Not a vector expression");
	return pow_exp_t<opExp1_t, scalar_t<Scalar>>(op1, scalar_t<Scalar>(s2));
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
pow_exp_t<var_t<Scalar>, opExp2_t> operator^(
	const gVector<Scalar>& v1,
	const opExp2_t& op2) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return pow_exp_t<var_t<Scalar>, opExp2_t>(var_t<Scalar>(v1), op2);
}

template<typename Scalar, typename opExp2_t,
	typename std::enable_if<is_expression<opExp2_t>::value, int>::type = 0 >
	pow_exp_t<scalar_t<Scalar>, opExp2_t > operator^(
	Scalar s1,
	const opExp2_t& op2
	) {
	static_assert(opExp2_t::is_exp, "Not a vector expression");
	return pow_exp_t<scalar_t<Scalar>, opExp2_t>(scalar_t<Scalar>(s1), op2);
}
